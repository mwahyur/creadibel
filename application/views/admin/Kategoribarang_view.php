    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <button class="btn btn-success" onclick="add_kategori()"><i class="glyphicon glyphicon-plus"></i> Add Data Kategori Barang</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/Kategori_barang/ajax_list')?>",
                    "type": "POST"
                },
        ...
        function edit_kategori(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('admin/Kategori_barang/ajax_edit/')?>/" + id,
                type: "GET",
                dataType: "JSON",
...
//                    document.getElementById(data.kecamatan).selected="true";
                    $('[name="nama_kategori_barang"]').val(data.nama_kategori_barang);
                    $('[name="diskripsi_kategori_barang"]').val(data.diskripsi_kategori_barang);
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('admin/Kategori_barang/ajax_add')?>";
            } else {
                url = "<?php echo site_url('admin/Kategori_barang/ajax_update')?>";
            }
        ...
        function delete_kategori(id)
        {
            if(confirm('Are you sure delete this data?'))
            {
                ...
                $.ajax({
                    url : "<?php echo site_url('admin/Kategori_barang/ajax_delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Form Data Kategori Barang</h3>
                </div>
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="nama_kategori_barang" placeholder="Nama Kategori" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Desikripsi Kategori</label>
                                <div class="col-md-9">
                                    <textarea name="diskripsi_kategori_barang" cols="57" rows="5"></textarea>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
